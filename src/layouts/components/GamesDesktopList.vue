...
<template>
  <div>
    <!-- GAMES LINK -->
    <b-modal
      id="gamelinkDesktopList"
      hide-footer
      class="center"
      ref="gamelinkDesktopList"
      centered
      size="sm"
      scrollable
    >
    ...
    >
      ...
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in playtechList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in mxList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in jokerList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in pgsoftList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in mgList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in playngoList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in otList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <!-- Baris 1 -->
      <b-row class="center" style="padding: 0px">
        <b-col v-for="pt in giocoList" :key="pt.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
    ...
    >
      ...
      <b-row class="center" style="padding: 0px">
        <b-col v-for="hb in hbList" :key="hb.gameCode" cols="2">
          <b-img
            loading="lazy"
            fluid-grow
            ...
            class="game-img-slot"
            :src="
              require(`@/assets/images/games/games-slot/HB/${hb.gameCode}.png`)
            "
            alt="None"
          />
        </b-col>
